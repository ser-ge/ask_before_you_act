...
class BrainNet(nn.Module):
    def __init__(self, question_rnn, action_dim=7, hidden_q_dim=128, mem_hidden_dim=64):
        ...
        self.policy_input_dim =  self.cnn_encoding_dim + 2 + self.hidden_q_dim + self.mem_hidden_dim
...
class BrainNetMem(BrainNet):
    ...
    def __init__(self, question_rnn, action_dim=7):
        super().__init__(question_rnn, action_dim)
        self.memory_rnn = nn.LSTMCell(self.cnn_encoding_dim+7+2+self.hidden_q_dim, self.mem_hidden_dim)
...
class BrainNetMemExpMem(BrainNetMem):
    def __init__(self, question_rnn, action_dim=7):
        super().__init__(question_rnn, action_dim)
